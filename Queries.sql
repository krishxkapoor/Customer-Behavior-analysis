    -- Q1. Total revenue generated by male and female
SELECT gender,
...
-- Q3. Top 5 products with the highest review rating
...
-- Q6. Top 5 products with the highest % of purchases where discount is applied
SELECT item_purchased,
...
LIMIT 5;
-- These products rely heavily on discounts
...
-- Q8. Top 3 purchased products within each category
WITH item_count AS (
    SELECT 
        category,
        item_purchased,
